...
public:
    ...
    //float ReadLux_Auto();
    float ReadLux_lvl(int lux_lvl);
    void SetIT_Index(signed int IT);
    void SetG_Index(signed int G);
    void ON();
    void OFF();
...
private:
    ...
    static constexpr float MAX_RESOLUTION = 0.0042; // Resolution with a gain X2 and integration time of 800ms
