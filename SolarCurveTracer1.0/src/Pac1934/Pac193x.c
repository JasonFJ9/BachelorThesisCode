#define SOURCE_FILE "src/pac1934/pac193x.c"
...
#include "../include/Pac1934/Pac193x.h"
#include "Pac193xInternal.h"
#include "../include/Pac1934/Pac193xTypedefs.h"
...
pac193xErrorCode_t pac193xInit(pac193xSensorConfiguration_t sensor) {
    i2cInit(sensor.i2c_host, (400 * 1000), 20, 21);
