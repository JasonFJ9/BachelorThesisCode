...
int main(void) {
    ...
    while (1) {
        ...
        case 't':
            ...
            for (int control_no = 0; control_no <= 255; control_no++){
                
                mcp23017_set_pins_gpiob(mcp23017_i2c, mcp23017_addr, control_no);
                mcp23017_set_pins_gpioa(mcp23017_i2c, mcp23017_addr, control_no);
                
                float R_Load = calculate_R_Load(measurement_mode_int,control_no);
